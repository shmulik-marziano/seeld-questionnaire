# ⚠ This repository has been consolidated into lenny-hq
...
**archived on GitHub** (Settings → Archive this repository) — not deleted — so its
git history remains available.

MOVED_TO: lenny-hq/15_ARCHIVE/2026-07/repo-consolidation/seeld-questionnaire/
